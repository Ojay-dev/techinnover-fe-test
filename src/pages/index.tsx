	...
	return (
		<div>
			<div className="pattern">
				<div className="relative  h-screen w-5/6 max-w-screen-2xl pt-20 lg:flex lg:justify-between xl:ml-0 xl:w-full 2xl:mx-auto">
					<div className="mt-3.5 text-white xl:ml-[3%] xl:w-1/2 2xl:xl:ml-0">
						<h1 className="font-heading text-[54px] uppercase leading-[76px]">
						...
						<p className="mt-[10px] font-text text-[19px] leading-8 lg:w-3/5">
			...
			<div className="m-auto w-5/6 max-w-screen-2xl gap-x-[10%] pt-20 pb-16 lg:mr-auto  lg:flex xl:ml-[3%] 2xl:mx-auto">
				...
				<div className="mt-12 lg:w-1/2">
					<h2 className="font-heading text-[38px] leading-[52px]">
						YOUR CAREER IS IN YOUR HANDS
					</h2>

					<p className="mt-[22px] font-text text-[19px] leading-8">
						Figma files can also be downloaded from our store. These files
